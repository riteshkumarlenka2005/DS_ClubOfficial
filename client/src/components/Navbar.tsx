  ...
  return (
    <>
      ...
      <div className="fixed top-[12px] right-[15px] md:top-[16px] md:right-[20px] z-[100] flex items-center gap-3">
        ...
        {/* ── Menu: pure CSS group-hover ── */}
        <div className="group relative before:absolute before:-bottom-8 before:left-0 before:w-full before:h-8">
          <div className="flex items-center justify-center w-[36px] h-[36px] md:w-[48px] md:h-[48px] text-white cursor-pointer transition-opacity hover:opacity-75 bg-black/70 backdrop-blur-md rounded-full border border-white/10">
          ...
          {/* Dropdown — visible on group hover, stays open while hovering itself */}
          <div className="absolute top-[52px] right-0 z-[99] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out translate-y-2.5 group-hover:translate-y-0 w-[280px]">
            <div
              style={{
